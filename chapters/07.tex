...
As mentioned in section \sectref{sec:nefdt:theorychange}, the question of the evolution of language reset the agenda in theoretical linguistics at this time. The grammatical formalisms assumed to underlie the cognitive aspects of linguistic competence were forced to change with this new perspective, with the result that many of the advances made by the P\&P and Government and Binding (\citeyear{Chomsky1981}) theories needed to be abandoned. The rationale was something of the following sort:
...
\\\textsc{gpsg} - Generalised Phrase Structure Grammar
